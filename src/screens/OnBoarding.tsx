...
const OnBoardingScreen: React.FC = () => {
  ...
  return (
    <Wrapper>
      ...
      >
        <PageWrapper key="1">
          <FirstPage setPageStatus={setPageStatus} activePageIndex={activePageIndex} pageIndex={0}/>
        </PageWrapper>
        <PageWrapper key="2">
          <SecondPage setPageStatus={setPageStatus} activePageIndex={activePageIndex} pageIndex={1}/>
        </PageWrapper>
        <PageWrapper key="3">
